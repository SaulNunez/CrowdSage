    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnswerBookmarks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnswerBookmarks_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnswerBookmarks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerBookmarks_AnswerId",
                table: "AnswerBookmarks",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_AnswerBookmarks_UserId",
                table: "AnswerBookmarks",
                column: "UserId");
